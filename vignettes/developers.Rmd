...
-   A translator calls `po_create()` to generate a `.po` file for each language that your messages will be translated to.
...
This vignette will show you have to use the `po_` functions to generate the various files needed for translation and help to you write messages that can be effectively translated.
