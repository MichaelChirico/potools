...
In this vignette you'll learn how to set up your package for translation, focussing on translating messages in your R code.
...
While Mongolian uses the same times of day, it arranges the words in the opposite order to English: "Өглөөний мэнд" is morning greetings, "Өдрийн мэнд" is afternoon greetings, and "Оройн мэнд" is evening greetings.
